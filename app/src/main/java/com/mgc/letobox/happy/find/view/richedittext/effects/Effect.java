...
import com.mgc.letobox.happy.find.view.richedittext.utils.Selection;
...
abstract public class Effect<V extends Object> {
    ...
    /**
     * Create an Span for this effect.
     * This method is used in applyToSelection(RTEditText, V).
     * If the Span can't be created only with V as value parameter then applyToSelection needs
