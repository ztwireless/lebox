define("libs/weapp-adapter/XMLHttpRequest.js", function(require, module, exports, process) {
 'use strict';
  ...
  _createClass(XMLHttpRequest, [{
    ...
    value: function send() {
      ...
      if (this.readyState !== XMLHttpRequest.OPENED) {
       ...
       // 这里将json转换为kv对
        var is_json_str = typeof data == 'string' && data.startsWith('{')
        var is_json = typeof data == 'object'
        if(_method.get(this).toLowerCase() == 'post' && (is_json || is_json_str)) {
          if(is_json_str) {
